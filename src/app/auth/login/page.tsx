...
import { FadeIn, ScaleIn } from '@/components/animations/PageTransition';
...
export default function LoginPage() {
  ...
  const { signInWithEmail, signUpWithEmail, signInWithGoogle, googleSignInAvailable } = useAuth();
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-20">
      ...
      <div className="relative w-full max-w-md">
          ...
          <div className="glass-card p-8">
            ...
            <div className="flex justify-center mb-8">
              <Link href="/" className="flex items-center space-x-2">
                ...
                <span className="text-3xl font-display font-bold gradient-text">ORBIT</span>
              </Link>
            </div>
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-dark-100 text-gray-500">or</span>
              </div>
            </div>
            ...
            {googleSignInAvailable ? (
              ...
              <div className="text-center text-sm text-gray-500 p-4 glass-card rounded-lg">
                <p>Google Sign-In is not available.</p>
                <p className="mt-1 text-xs">Use email/password to continue.</p>
              </div>
            )}
            ...
            <p className="mt-8 text-center text-gray-400">
              ...
              <button
                ...
                className="ml-2 text-neon-blue hover:text-neon-blue/80 transition-colors font-medium"
              >
        ...
        <div className="absolute -bottom-20 -right-20 w-40 h-40 bg-neon-purple/20 rounded-full blur-3xl" />
      </div>
    </div>
  );
}
